...
- Invoke the `harness-advanced-elicitation` skill with specific decision categories
...
- Invoke the `harness-party-mode` skill with architectural decisions context
