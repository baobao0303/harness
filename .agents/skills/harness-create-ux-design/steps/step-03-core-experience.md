...
- Invoke the `harness-advanced-elicitation` skill with the current core experience content
...
- Invoke the `harness-party-mode` skill with the current core experience definition
