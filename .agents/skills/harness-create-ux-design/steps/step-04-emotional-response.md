...
- Invoke the `harness-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `harness-party-mode` skill with the current emotional response definition
