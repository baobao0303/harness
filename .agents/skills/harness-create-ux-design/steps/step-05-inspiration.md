...
- Invoke the `harness-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `harness-party-mode` skill with the current inspiration analysis
