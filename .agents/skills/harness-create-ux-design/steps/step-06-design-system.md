...
- Invoke the `harness-advanced-elicitation` skill with the current design system content
...
- Invoke the `harness-party-mode` skill with the current design system choice
