...
- Invoke the `harness-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `harness-party-mode` skill with the current defining experience
