...
- Invoke the `harness-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `harness-party-mode` skill with the current visual foundation
