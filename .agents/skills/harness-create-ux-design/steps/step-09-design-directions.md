...
- Invoke the `harness-advanced-elicitation` skill with the current design direction content
...
- Invoke the `harness-party-mode` skill with the current design direction
