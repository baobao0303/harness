...
- Invoke the `harness-advanced-elicitation` skill with the current component strategy content
...
- Invoke the `harness-party-mode` skill with the current component strategy
