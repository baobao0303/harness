...
- When 'A' selected: Invoke the `harness-advanced-elicitation` skill
- When 'P' selected: Invoke the `harness-party-mode` skill
...
- Invoke the `harness-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `harness-party-mode` skill with the current responsive/accessibility strategy
